package aed;
 ...
 /**Secuencia.java → es una interfaz: define qué operaciones debe 
  * tener cualquier secuencia (como agregar, eliminar, obtener).
No tiene implementación concreta, es sólo un contrato.
     * 
     */
